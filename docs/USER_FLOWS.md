...
Logs one Garmin proof-backed sleep record for its local wake date. Re-submitting the same wake date replaces that member's record. The bot retains proof submission, not the screenshot URL.
